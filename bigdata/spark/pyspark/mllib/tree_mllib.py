...
class RandomForest: # pyspark.mllib.tree.RandomForest
  ...
  def trainClassifier(data, numClasses, categoricalFeaturesInfo, numTrees, featureSubsetStrategy='auto', impurity='gini', maxDepth=4, maxBins=32, seed=None):
    '''
    ...
    @impurity: Criterion used for information gain calculation. Supported values:   -
	  ¡°gini¡± (recommended) or ¡°entropy¡±.
    @maxDepth: Maximum depth of the tree. E.g., depth 0 means 1 leaf node; depth 1 m-
	  eans 1 internal node + 2 leaf nodes. (default: 4)
