...
/************************************************************************************
 ...
 @exec, because a new process is not created; @exec merely replaces the current process ¡ª 
 its text, data, heap, and stack segments ¡ª with a brand-new program from disk.
